...
export default function SuperBowlBlog() {
  return (
    <StyledBlogPaper elevation={4} className={classes.container}>
      ...
      <Typography variant="body1">
        ...
        they easily achieved the first-round bye and took care of business vs their rival Cincinnati to get here.
        <br /><br />
        ...
        given Chiefs fans optimism that the defensive line can wreak enough havoc to make up for the inexperienced
        backend. Their MLB, Nick Bolton, is a fast and cerebral player who I don’t think I’ve ever seen miss
        a tackle.<br /><br />
      </Typography>

      <Typography variant="h4">Predictions</Typography>
      <Typography variant="body1">
        The consensus line for this game seems to have settled at Philly -1.5, with a total of 51. Odds below
        are courtesy of Circa Sports as of 2/9.
      </Typography><br />
      ...
      <Typography variant="body1">
        Mahomes has only played 12 games with a spread of 2.5 or less, going 6-3 ATS in the regular season and
        3-0 in the playoffs.
      </Typography>
      <ul>
      ...
      <Typography>
        ...
        I don’t see this game ending with a difference of 1; of course a late missed XP can do the job, but I think
        a 2 point conversion in OT could happen with the new rules, so if Chiefs ML scares you, look into Chiefs +3
        -148 or Game to go to OT +830 to hedge.
      </Typography><br />

      <Typography variant="h5" className={classes.smallHeader}>High-total Super Bowls</Typography>
      <Typography variant="body1">
        In 13 Super Bowls, the total was more than 7 touchdowns (49.5-57). In these games, the over is 4-9 and the
        favorites are 7-6 ATS.<br /><br />

        Looking at the same set of 13 Super Bowls, we see that reverse teaser unders are 8-5 and 5-8 for selling 6
        and 10 points, respectively. In other words, taking the under a touchdown (6) <i>lower</i> than the total has
        gone an astounding <b>61.5%</b> and betting the under 10 points lower than the total has still gone 5-8. For
        these reasons, I like these plays:
      </Typography>
      <ul>
      ...
      <Typography variant="body1">
        Travis Kelce’s 2+ TD prop has an implied probability of 17.4% (Circa) but his MVP odds sit at 15-1. Looking
        at the last 21 Super Bowls (since 2000), 13 QBs, 5 WRs, and 3 defensive players have won the award. Similar
        to the regular season MVP, it’s become a QB award, however there is potential value in a non-QB taking it
        home. Let’s take a look at the leading receivers of each Super Bowl winning team (since losing players will
        not win the award).
      </Typography>
      ...
      <Typography variant="body1">
        ...
        game to win the MVP, but lost it to the QB. 2016 James White, 2010 Jordy Nelson, and 2003 Deion Branch.
        In a very general view, it appears that 8+ catches, 120+ yards, and a touchdown or 2 will give skill
        players a great chance to take the MVP home. This, of course, is assuming the QB doesn’t go nuclear
        (350+ yards/4+ TDs) since it is the QB’s award to lose.<br /><br />

        The 3 defensive MVPs hailed from 3 of the greatest defenses of this century: ‘02 Bucs, ‘13 Seahawks, and
        ‘15 Broncos. 2 of the 3 were blowouts, and Von won Denver the game on a strip-sack with 4 minutes left in
        the game. It seems that the recipe for defensive players is a blowout or a super-human performance combined
        with a high-leverage moment of the game.<br /><br />

        This is why I love <mark>Travis Kelce to win SB MVP (15-1)</mark>. Circa’s prop for Kelce to have
        100+ yards/1 TD has an implied probability of 27.8%, and should be slightly correlated with a KC win.
        Of course we’ll probably need more help than just 8-100-1 (unless it’s a close, very low scoring game)
        but there is likely 0 to negative value on Mahomes at +130. Using the Chiefs ML implied odds, Mahomes will
        win the MVP over 90% of the time given a Chiefs win, which makes sense given his ability, but doesn’t
        provide enough value for me to play. On the other hand, Jalen Hurts’ MVP odds reflect a 75% chance of
